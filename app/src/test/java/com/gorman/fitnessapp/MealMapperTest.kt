...
class MealMapperTest {
    ...
    fun `MealPlanTemplate toEntity mapping is correct`() {
        ...
        // Assert
        Assert.assertEquals(domainTemplate.supabaseId, entity.supabaseId)
    ...
    fun `MealPlanItem toEntity mapping is correct`() {
        ...
        // Assert
        Assert.assertEquals(domainItem.supabaseId, entity.supabaseId)
